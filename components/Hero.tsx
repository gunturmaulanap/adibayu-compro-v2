  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div 
        ...
        style={{
          // Using a high-quality industrial/cityscape placeholder since the uploaded image isn't available in the file system
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 w-full max-w-5xl mx-auto mt-20">
        ...
        >
          Advancing Industries.<br />Driving Growth.
        </motion.h1>
