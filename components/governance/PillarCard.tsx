...
export default function PillarCard({ pillar }: PillarCardProps) {
  ...
  return (
    <section
      className={`rounded-[24px] bg-white p-6 shadow-sm ring-1 transition-all duration-200 dark:bg-[#0b111c] ${
        isCompanyHovered
          ? "ring-gray-300 shadow-md dark:ring-slate-500"
          : "ring-black/5 dark:ring-white/10"
      }`}
      aria-label={`${pillar.name} pillar`}
    >
      <div className="mb-5 border-l-2 border-gray-300 pl-4 dark:border-slate-600">
